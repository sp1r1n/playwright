...
test.describe('Posts API', () => {
  test(
    'GET /posts - should return list of posts',
    { tag: '@smoke' },
    async ({ api }) => {
  ...
  test(
    'GET /posts/:id - should return single post',
    { tag: '@regression' },
    async ({ api }) => {
      await allure.feature('Posts API');
  ...
  test(
    'GET /posts - should filter posts by userId',
    { tag: '@functional' },
    async ({ api }) => {
      await allure.feature('Posts API');
  ...
  test(
    'PUT /posts/:id - should update entire post',
    { tag: '@regression' },
    async ({ api }) => {
      await allure.feature('Posts API');
  ...
  test(
    'DELETE /posts/:id - should delete post',
    { tag: '@regression' },
    async ({ api }) => {
      await allure.feature('Posts API');
